    ...
    >
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10 flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-gradient-green">Welcome to The FOSS Club!</h1>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                target="_blank"
                className="inline-flex items-center px-6 py-3 bg-gradient-green text-white rounded-full font-medium text-lg hover:opacity-90 transition-opacity"
              >
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto">
              <div className="absolute inset-0 bg-gradient-green-blue rounded-full opacity-90"></div>
      ...
      <section ref={sectionRefs.about} id="about" className="py-20 relative">
        <div className="container mx-auto px-4">
          <motion.h2
            className="text-4xl font-bold mb-12 text-center text-gradient-green animate-on-scroll"
          ...
          <motion.div
            className="max-w-4xl mx-auto backdrop-blur-sm p-8 rounded-3xl border border-gray-800 dark:border-gray-800 bg-white/5 dark:bg-black/5 animate-on-scroll"
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-4 text-gradient-green-dark">Core Pillars</h3>
            <ul className="space-y-4">
              <motion.li
                className="p-4 bg-gray-900/10 dark:bg-gray-900/50 rounded-2xl border-gradient border-gradient-green"
                whileHover={{ x: 10 }}
              >
      ...
      <section ref={sectionRefs.events} id="events" className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            className="mt-16 p-8 rounded-3xl border border-green-900/50 bg-gradient-to-r from-green-900/10 to-green-900/10 dark:from-green-900/30 dark:to-green-900/30 animate-on-scroll"
          ...
          >
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
                <h3 className="text-3xl font-bold mb-4 text-gradient-green">FOSS Hack 2025</h3>
                <p className="text-lg mb-4 dark:text-gray-300">
                  Our biggest hackathon yet! Join us for an incredible weekend of coding, collaboration, and innovation
                  in the open source world.
                </p>
                <h4 className="text-xl font-semibold mb-2 text-gradient-green-light">What's in store?</h4>
      ...
      <section ref={sectionRefs.resources} id="resources" className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          >
            <ul className="space-y-4">
              <motion.li
                className="p-4 bg-gray-900/10 dark:bg-gray-900/50 rounded-2xl border-gradient border-gradient-green transition-all"
                whileHover={{ x: 10, backgroundColor: "rgba(31, 41, 55, 0.8)" }}
              >
                <Link href="#" className="flex items-center text-lg hover:text-gradient-green transition-colors">
