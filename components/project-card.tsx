...
export default function ProjectCard({ title, description, link, index }: ProjectCardProps) {
  return (
    <motion.div
      className="backdrop-blur-sm p-6 rounded-3xl border border-gray-800 dark:border-gray-800 bg-white/5 dark:bg-black/5 hover:border-red-500/50 transition-all group"
    ...
    >
      <div className="h-full flex flex-col">
        <h3 className="text-2xl font-bold mb-3 text-red-500 dark:text-red-400 group-hover:text-red-400 dark:group-hover:text-red-300 transition-colors">
          {title}
        </h3>
