...
export default function BlogPost({ title, excerpt, link, index }: BlogPostProps) {
  return (
    <motion.article
      className="backdrop-blur-sm p-6 rounded-3xl border border-gray-800 dark:border-gray-800 bg-white/5 dark:bg-black/5 hover:border-green-500/50 transition-all group h-full flex flex-col"
      ...
      whileHover={{ y: -5 }}
    >
      <h3 className="text-xl font-bold mb-3 group-hover:text-green-500 dark:group-hover:text-green-400 transition-colors">
        {title}
      </h3>
