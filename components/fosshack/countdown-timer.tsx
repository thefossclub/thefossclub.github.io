...
export function CountdownTimer() {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-background/90 backdrop-blur-md rounded-3xl p-8 border border-[rgba(var(--accent-green),0.6)]">
            ...
            >
              <div className="relative overflow-hidden">
                <motion.div
                  ...
                  animate="animate"
                  exit="exit"
                  className="bg-foreground/10 text-foreground rounded-2xl p-4 aspect-square flex items-center justify-center border border-foreground/10"
                  transition={{
                    duration: 0.35,
                ...
                >
                  <div className="text-center">
                    ...
                    <span className="block text-xs md:text-sm mt-1 text-foreground/60">
                      {block.label}
                    </span>
                  </div>
                </motion.div>
